...
### Function Parameter (Void swap (T &a, t &b)):
...
Rational r4 (r1); // after c++ 17, this statment states intialization of r4 with r1 and the compiler deduces the type of r4 from r1.
```
