...
### 4/08/2021
1. Learned how to create a flow chart presentation

### 4/09/2021
- Created presentation on the following two projects:
1.  COMPUTING FFT
2. EXPOSING C++ API TO JAVA - It was incorrect
- Organized, proofread, and formatted all notes

### 4/10/2021
1. I learned what is a markdown file and how to edit it
2. I edited the markdown file, "Notes" in visual studio code
3. Worked on questions I had from Object-oriented programing 

### 4/11/2021
1. Finished formatting markdown files, Journal, and Meeting Notes.